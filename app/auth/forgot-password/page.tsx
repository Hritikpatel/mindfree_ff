            ...
            <div className="relative w-full md:w-1/2 flex items-center justify-center p-8 bg-gray-50 overflow-clip">
                ...
                <div className="w-full max-w-md space-y-8 z-20">
                    <div className="text-left">
                        <h2 className="text-4xl font-bold text-[#004D4D]">Forgot Password</h2>
                        <p className="mt-2 text-black font-light">Enter the email associated with your account and we&apos;ll email you password reset link.</p>
                    </div>
                    ...
                    <form className="mt-8 space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-1/2 m-auto flex justify-center py-2 px-4 border border-transparent rounded-xl text-15 font-medium text-black bg-[#87CEEB] hover:bg-[#82c6e1] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#87CEEB] transition-all hover:scale-99 group"
                        >
                            Send Reset Link
                        </button>
                    </form>
